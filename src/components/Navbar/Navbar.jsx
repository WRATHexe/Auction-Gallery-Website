...
const Navbar = () => {
  ...
  <div className="flex-none">
    <a className="btn btn-ghost text-3xl"><span className='text-blue-950'>Auction</span><span className='text-yellow-300 font-bold'>Gallery</span></a>
  </div>
  <div className="flex-1 flex justify-center">
        <ul className="menu menu-horizontal px-1 text-2xl gap-20 font-semibold">
            <li><a>Home</a></li>
            <li><a>Auctions</a></li>
